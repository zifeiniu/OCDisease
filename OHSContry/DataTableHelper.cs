...
namespace OHSUploadLibrary
{
    ...
    {
        public static string GetFirstRowByColName(this DataRow row, string colName)
        {
            try
            {
        ...
        public static string GetFirstRowByColName(this DataTable table,string colName)
        {
            try
            {
                if (table.Rows.Count > 0 && table.Columns.Contains(colName))
                {
